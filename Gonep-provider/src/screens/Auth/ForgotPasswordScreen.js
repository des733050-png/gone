    ...
    <View style={[styles.root, { backgroundColor: C.bg }]}>
      ...
      >
        <View style={styles.cardWrapper}>
          <TouchableOpacity onPress={onBack} style={[styles.backRow, { marginBottom: 12 }]}>
          ...
          <View style={[styles.card, { backgroundColor: C.card, borderColor: C.border }]}>
            ...
            <Text style={[styles.sub, { color: C.textMuted }]}>
              {step === 'email' && 'Enter your work email. We will send a one-time code if the account exists.'}
              {step === 'otp' && 'Enter the 6-digit code from your email.'}
              {step === 'done' && 'Use this temporary password to sign in, then change it from your profile.'}
            </Text>

            {error ? (
              <View style={[styles.banner, { backgroundColor: `${C.danger}12`, borderColor: `${C.danger}40` }]}>
            ...
            {info && step === 'otp' ? (
              <View style={[styles.banner, { backgroundColor: `${C.primary}10`, borderColor: `${C.primary}35` }]}>
...
const styles = StyleSheet.create({
  ...
  banner: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderRadius: 10, padding: 10, marginBottom: 14 },
