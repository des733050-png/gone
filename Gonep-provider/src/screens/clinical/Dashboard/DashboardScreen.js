...
export function DashboardScreen({ user, goTo }) {
  ...
  { icon:'trending-up',  lib:'feather', label:'Revenue this month',    value:'KSh 47k',            color:C.success, bg:C.successLight, page:'analytics',    roles:['hospital_admin','billing_manager'] },
  { icon:'alert-circle', lib:'feather', label:'Overdue invoices',      value: 1,                   color:C.danger,  bg:C.dangerLight,  page:'billing',      roles:['hospital_admin','billing_manager'] },
