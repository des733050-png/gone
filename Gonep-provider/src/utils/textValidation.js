...
// Helpers for free-form text fields (visit reason, consultation notes, etc.).
 ...
 * @param {number} minWords   Minimum word count (default 5).
 * @param {string} fieldLabel Display label, e.g. "Reason for visit".
 */
