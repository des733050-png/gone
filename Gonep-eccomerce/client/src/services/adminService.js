...
export const getPendingCategories = () => axiosInstance.get('/admin/categories/pending');
export const approveCategory = (id) => axiosInstance.patch(`/admin/categories/${id}/approve`);
export const getPendingBrands = () => axiosInstance.get('/admin/brands/pending');
export const approveBrand = (id) => axiosInstance.patch(`/admin/brands/${id}/approve`);
